			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"digitalsign-display": {
								"semanticObject": "digitalsign",
								"action": "display",
								"description": "Digital signature pad with clear, save and draw commands",
								"title": "Digital Signature",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=digitalsign",
									"url": sap.ui.require.toUrl("digitalsign")
								}
							}
						}
					}
